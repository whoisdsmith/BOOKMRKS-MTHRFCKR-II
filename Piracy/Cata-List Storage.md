...
[lino - Sticky and Photo Sharing for you](https://en.linoit.com) - lino is an online web sticky note service that can be used to post memos, to-do lists, ideas, and photos anywhere on an online web canvas. lino is a completely free service that runs on all popular web browsers.

2022-11-05T23:14:05.620Z
...
[Stamen Maps](https://maps.stamen.com) - Stamen's toner, terrain and watercolor map styles are lovingly crafted and free for the taking.

2022-11-05T23:14:05.619Z
...
[Rainyscope: web-based rain simulator](https://rainyscope.com) - Let the rain sing you a lullaby. Sounds of rain for sleeping or studying.
...
[Start.io-Mobile Marketing & Audience Platform for Marketers](https://start.io) - We are a mobile data platform that enables organizations to uncover AI-driven insights and make data-driven decisions that enhance strategies and drive growth
...
[Home](https://www.animatedknots.com) - Animated Knots is the world's leading site for learning how to tie knots of any kind. From Boating Knots, Fishing Knots and Climbing Knots to how to tie a Tie, or even Surgical Knots  weve got it covered.
...
[Globe Genie](https://www.globegenie.com) - Globe Genie teleports you to a random spot somewhere across the world.
...
[Planet Publish](https://www.planetpublish.com) - Free PDF eBooks Archive by Planet PDF
...
[Open and free content on JSTOR and Artstor - About JSTOR](https://about.jstor.org/oa-and-free) - How to find the millions of journal articles, ebooks, images, and other media available on JSTOR and Artstor as Open Access or free to everyone.
...
[NotesHub - Take Notes, Sync and Collaborate](https://about.noteshub.app) - Fully cross-platform, vendor-agnostic, markdown based note-taking app
...
[Artistic visualization of heights](https://anvaka.github.io/peak-map) - This website is allows you to pick any region of the world and print its high points in artistic, joyful manner.
...
[The Memory Techniques Wiki](https://artofmemory.com/wiki/Main_Page) - The Art of Memory Wiki is a free, online encyclopedia of memory techniques, mental calculation, and related brain training information. For

2022-11-05T23:14:05.612Z
...
[Atlas of Surveillance](https://atlasofsurveillance.org) - Documenting Police Tech in Our Communities with Open Source Research
...
[Burner Mail - Fast, Easy, Burner Email Addresses](https://burnermail.io) - Detects email fields and automagically fills them with a burner email address that forwards to your personal email address
...
[Calmy Leon](https://calmyleon.com) - World's most relaxing music player and sound generator.
...
[Homey: Productive and cozy start page](https://chrome.google.com/webstore/detail/homey-your-start-page-on/lllnjdmfnfjifcfpppjmcnanpokikcpl) - Turn your new tab into a productive workspace, organize bookmarks, motivates with daily live wallpapers and inspirational quotes
...
[Citymapper - The Ultimate Transport App](https://citymapper.com) - The ultimate transport app - iPhone-Android-Web

2022-11-05T23:14:05.609Z
...
[CityWalks.live](https://citywalks.live) - A web platform that you can virtually travel around the world.
...
[Copernix - Know thy World](https://copernix.io) - Explore the world using Wikipedia on a map. Copernix lets you search for information in a new, easy and intuitive way.
...
[Home - Dissemin](https://dissem.in) - Dissemin detects papers behind pay-walls and invites their authors to upload them in one click to an open repository.

2022-11-05T23:14:05.607Z
...
[Drive & Listen](https://driveandlisten.herokuapp.com) - Drive around cities while listening to their local radios
...
[Earth.fm: Listen to nature sounds, fall in love with the Earth](https://earth.fm) - A non-profit, growing library of immersive nature sounds from all over the world. Become part of our family and help preserve the planet.
...
[Google Earth Timelapse](https://earthengine.google.com/timelapse) - Explore the dynamics of our changing planet over the past three and a half decades.

2022-11-05T23:14:05.606Z
...
[En-ROADS Climate Scenario](https://en-roads.climateinteractive.org) - Interact with this global scenario of climate action
...
[Library Genesis - Wikipedia](https://en.wikipedia.org/wiki/Library_Genesis) - nan
...
[WikiJournal User Group - Wikiversity](https://en.wikiversity.org/wiki/WikiJournal_User_Group) - nan

2022-11-05T23:14:05.605Z
...
[Examine: nutrition and supplement information you can trust](https://examine.com) - Examine - Independent scientific information on health, nutrition, and supplements. Everything on Examine.com is backed with citations to published scientific studies.
...
[Felt The best way to make maps on the internet](https://felt.com) - Felt lets you create maps collaboratively, using world-class data, and share them in a single click. For team projects or epic adventure with friends.
...
[Flowshare: How To Guides For Everyday Software](https://flowshare.io) - Flowshare: How To Guides For Everyday Software. Follow Easily With Screenshots For Every Step.
...
[Footpath Route Planner](https://footpathapp.com) - Map routes with your finger and follow along with turn-by-turn navigation.
...
[GitHub - ether/etherpad-lite: Etherpad: A modern really-real-time collaborative document editor.](https://github.com/ether/etherpad-lite) - Etherpad: A modern really-real-time collaborative document editor. - GitHub - ether/etherpad-lite: Etherpad: A modern really-real-time collaborative document editor.

2022-11-05T23:14:05.602Z
...
[GitHub - feross/simple-peer: Simple WebRTC video, voice, and data channels](https://github.com/feross/simple-peer) - Simple WebRTC video, voice, and data channels. Contribute to feross/simple-peer development by creating an account on GitHub.
...
[GitHub - iamadamdev/bypass-paywalls-firefox: Bypass Paywalls for Firefox](https://github.com/iamadamdev/bypass-paywalls-firefox) - Bypass Paywalls for Firefox. Contribute to iamadamdev/bypass-paywalls-firefox development by creating an account on GitHub.
...
[GitHub - macouella/linkdash: Generate a handy dashboard of links in seconds.](https://github.com/igimanaloto/linkdash) - Generate a handy dashboard of links in seconds. Contribute to macouella/linkdash development by creating an account on GitHub.
...
[GitHub - rust-lang/mdBook: Create book from markdown files. Like Gitbook but implemented in Rust](https://github.com/rust-lang/mdBook) - Create book from markdown files. Like Gitbook but implemented in Rust - GitHub - rust-lang/mdBook: Create book from markdown files. Like Gitbook but implemented in Rust

2022-11-05T23:14:05.601Z
...
[GitMind - Online Mind Mapping Software - On Any Device](https://gitmind.com) - GitMind is a professional mind map maker for brainstorming, project planning, development, action and other creative tasks. This tool lets you share mind maps with tons of users and collaborate with them.
...
[grocy - ERP beyond your fridge](https://grocy.info) - ERP beyond your fridge - grocy is a web-based self-hosted groceries & household management solution for your home. Open Source. Built with passion.
...
[Hipstersound-Cafe Restaurant ambient noise generator](https://hipstersound.com/ambience.html) - Ambient coffee shop sounds to stay focused at work.
...
[HistoryMaps: Learn World History Visually with Interactive 3D Maps and Timelines, Images, and Videos](https://history-maps.com) - Learn World History visually with Interactive 3D Maps, Timelines, Images, and Videos with HistoryMaps. With over 3000 historical events in 150 stories, from the Crusades, Samurais, Islamic Conquests, Vikings, Roman Republic, you'll find something interesting to discover or reread. Use the interactive map and timeline to learn where and when something happened. The beautiful images and videos make it even better
...
[IPFS Powers the Distributed Web](https://ipfs.io) - The InterPlanetary File System is a peer-to-peer hypermedia protocol designed to preserve and grow humanity's knowledge by making the web upgradeable, resilient, and more open.
...
[JoinPeerTube](https://joinpeertube.org/en) - PeerTube is a decentralized video hosting network, based on free/libre software. Join the federation and take back control of your videos!.
...
[LettuceMeet - Easy Group Scheduling](https://lettucemeet.com) - The easiest way to schedule group meetings.
...
[Test your geography knowledge - clickable map quizzes](https://lizardpoint.com/geography/index.php) - clickable map quizzes of the world
...
[Matrix.org](https://matrix.org) - Matrix is an open standard for interoperable, decentralised, real-time communication
...
[Mind42](https://mind42.com) - Get an overview about the different kind of mind map created on Mind42. Mind42 is a free online mind mapping software that allows you to collaborate on and publish your mind maps with others.
...
[Morse Code Translator - Morse Decoder](https://morsify.net) - Easy to use Morse code translator, translate Morse code to text and text to Morse code, play the sound of the Morse code.

2022-11-05T23:14:05.595Z
...
[The Deep Sea](https://neal.fun/deep-sea) - Scroll down the deep sea in this interactive page.
...
[Free online tool to gather content on a single page](https://netboard.me/index.html) - Gather texts, documents, links, videos, photos, presentations, RSS feeds and other stuff together on a personalized page
...
[Nomad List](https://nomadlist.com/climate-finder) - Pick a set of climate criteria like temperature, humdity and air quality and find cities that match (based on historical data from the past few years). For more broad filters, see Nomad List's frontpage
...
[Notejoy Fast and focused notes for you and your team](https://notejoy.com) - Powerful notes app for individuals and teams. Fast, focused, always in sync. Available on Mac, PC, iOS, Android, and the web. Sign up free.
...
[OnlyKey Hardware Password Manager-One PIN to remember](https://onlykey.io) - The only device that works everywhere to secure accounts, email, and communication online. Strong two-factor authentication and professional grade encryption. Use it to log into any device, application, or unlock encrypted drives.
...
[Parsify Desktop](https://parsify.app) - Parsify Desktop is a next generation, notepad-based calculator, built with extendibility and privacy in mind. It supports advances math, variables, user-defined units, custom plugins, and much more. We support major desktop operating systems, that is, macOS, Windows, and Linux.

2022-11-05T23:14:05.592Z
...
[Passnip](https://passnip.com) - Stop forgetting that f**king password, generate a random secure passphrase you can remember instantly in your browser.
...
[My daily PLANNER](https://paulina.website/daily-planner) - Organize your day with pen & paper.
...
[ONLYOFFICE](https://personal.onlyoffice.com) - ONLYOFFICE is a cloud office that enables you to manage documents, projects, team and customer relations in one place.

2022-11-05T23:14:05.591Z
...
[Home](https://pi-hole.net) - 1. Install a supported operating system You can run Pi-hole in a container, or deploy it directly to a supported operating system via our automated installer.
...
[Ruin My Search History: Ruin and protect your search history and privacy. Now 2022 updated.](https://proprivacy.com/ruinmysearchhistory) - Ruin your Google search history with a single click. Learn everything you need regarding search history and keeping private only.

2022-11-05T23:14:05.589Z
...
[Human Terrain](https://pudding.cool/2018/10/city_3d) - Visualizing the Worlds Population, in 3D
...
[Reader Mode](https://readermode.io) - All-one-one reading, bookmarking, highlighting and research app
...
[Relax.li](https://relax.li) - Relax! Take a moment to relax on this ultra relaxing website. You will feel so much fresher and better in a few moments...
...
[Rome in 3D - History in 3D](https://relivehistoryin3d.com/projects/rome-in-3d) - What is our Rome in 3D project in general? Broadly speaking, it is an attempt to give you an opportunity to take a look at Rome as it

2022-11-05T23:14:05.588Z
...
[Scout](https://scoutexplore.com) - Trip planning, simplified
...
[Bungo Search-Search free e-books by Time-to-Read from Project Gutenberg](https://search.bungomail.com/en) - Search free e-books by Time-to-Read from Project Gutenberg.
...
[Share and accept documents securely](https://securedrop.org) - SecureDrop is an open-source whistleblower submission system that media organizations can install to securely accept documents from anonymous sources. It was originally coded by the late Aaron Swartz and is now managed by Freedom of the Press Foundation.
...
[Send free anonymous email online](https://sendmail.altmails.com) - Send anonymous email with attachment for free, you can send unlimited emails securely with SendMail no registration required.
...
[Sleep Calculator: Ideal Bedtime & Wake Up Times - Sleepytime](https://sleepyti.me) - Formerly the Sleepytime Sleep Cycle Calculator, this tool will tell you exactly what time to fall asleep and wake up for optimal performance

2022-11-05T23:14:05.586Z
...
[Speechling - Speak Languages Better](https://speechling.com) - Learn to speak foreign languages. Listen to professional recordings, record yourself on 1000s of sentences, and get daily pronunciation feedback from coaches.
...
[Remote-controlled Countdown Timer](https://stagetimer.io) - Show a fullscreen timer to your presenter while you control it from another device. Runs in the browser. Basic version is free. Works on all screen sizes.

2022-11-05T23:14:05.585Z
...
[start.me](https://start.me/start/us/startpage) - Save time accessing the websites you visit every day. Go beyond bookmarks with our advanced dashboard features. Use across all your devices and browsers. At work, at school or at home.
...
[SubEthaEdit](https://subethaedit.net) - SubEthaEdit Homepage
...
[Substack - A new model for publishing](https://substack.com) - With Substack, anyone can start a publication that combines a personal website, blog, and email newsletter or podcast. It's quick and simple, so you don't have to be tech savvy. Your audience can pay you directly through subscriptions, with no ads to get in the way. Writers and podcasters can own their intellectual property, keep their mailing list, and start a media business.

2022-11-05T23:14:05.584Z
...
[Tailscale](https://tailscale.com) - Tailscale is a zero config VPN for building secure networks. Install on any device in minutes. Remote access from any network or physical location.
...
[Temp Mail - Disposable Temporary Email](https://temp-mail.org/en) - nan

2022-11-05T23:14:05.583Z
...
[Blacklight The Markup](https://themarkup.org/blacklight) - A Real-Time Website Privacy Inspector
...
[Online Planetarium - Interactive Sky Chart](https://theskylive.com/planetarium) - Interactive sky chart showing planets, asteroids, comets and interplanetary probes and how to find them from your location.
...
[Discover your travel budget plan like a local](https://thetripcost.com) - Estimate and search for a destination by your travel budget. Flights, hotel, airport transfer, local sim, transportation cost. Find cheap or fast tickets & visa
...
[Sounds of the Forest - Soundmap : Timber Festival](https://timberfestival.org.uk/soundsoftheforest-soundmap) - Explore the first ever forest soundmap of the world

2022-11-05T23:14:05.582Z
...
[Time Progress](https://time-progress.francesco.space) - Everytime you will open a new tab, you will be reminded that the time is running.
...
[Time and Date Calculator 100% Free](https://timedatecalc.com) - The Time and Date duration calculator allows you to easily add/subtract time and days, calculate days between dates, and also convert time to different units.
...
[COVID-19 (Coronavirus) Travel Restrictions - TripsGuard](https://tripsguard.com) - Where can I travel? TripsGuard allows you to get all COVID-19 travel restrictions and Coronavirus regulations around the world.
...
[Web 2.0 scientific calculator](https://web2.0calc.com) - Free Online Scientific Notation Calculator. Solve advanced problems in Physics, Mathematics and Engineering. Math Expression Renderer, Plots, Unit Converter, Equation Solver, Complex Numbers, Calculation History.

2022-11-05T23:14:05.579Z
...
[WebRoom-Your free virtual room for up to 12 participants](https://webroom.net) - WebRoom is your free virtual room with HD video and audio, screen sharing, Whiteboards and more for up to 12 participants. Our cloud-based tool includes all the features you need for effective live online classes and meetings.
...
[Whaller-Secure, customizable collaboration platform](https://whaller.com/en) - Build your own collaborative and social networks to faciliate communication and teamwork.
...
[Wikimap: A map of Wikipedia](https://wikimap.wiki) - A map of every geotagged article in Wikipedia

2022-11-05T23:14:05.578Z
...
[Wormhole - Simple, private file sharing](https://wormhole.app) - Wormhole lets you share files with end-to-end encryption and a link that automatically expires.

2022-11-05T23:14:05.577Z
...
[Write.as](https://write.as) - Simple writing platform built to preserve and spread your words. Start writing and publishing now  no signup required.
...
[Discover your life goals in 20 minutes](https://www.angstrom.life/goals) - Discover your life goals (in 20mins) - A free interactive guide
...
[Organize your life and manage your team's work with Any.do](https://www.any.do) - One app to easily manage your tasks, projects, and team's work. Trusted by +30m people and teams worldwide to stay organized and get more done. Try now for Free
...
[Beeper All your chats in one app. Yes, really.](https://www.beeper.com/?hn=) - A single app to chat on iMessage, WhatsApp, and 13 other chat networks. You can search, snooze, or archive messages. And with a unified inbox, youll never miss a message again.

2022-11-05T23:14:05.576Z
...
[International Dark Sky Association - International Dark-Sky Association](https://www.darksky.org) - [et_pb_section fb_built=1 _builder_version=3.22][et_pb_row _builder_version=3.25 background_size=initial background_position=top_left background_repeat=repeat][et_pb_column type=4_4 _builder_version=3.25 custom_padding=||| custom_padding__hover=|||][et_pb_text _builder_version=3.27.4 background_size=initial background_position=top_left background_repeat=repeat] IDA is a non-profit organization that works to help stop light pollution and protect the night skies for present and []
...
[Dropbox Transfer](https://www.dropbox.com/transfer/about) - Find out just how easy it is to make fast and secure file transfers to your friends, family, colleagues or another device with Dropbox.

2022-11-05T23:14:05.574Z
...
[FEATool Multiphysics - Physics Simulation Made Easy](https://www.featool.com) - FEATool is a fully integrated and easy to use toolbox for simulation of structural mechanics, heat transfer, CFD, and multiphysics engineering applications.
...
[FireRTC - No Nonsense Free Phone Calls To the US and Canada](https://www.firertc.com) - FireRTC enables you to make and record phone calls right from your Chrome or Firefox web browser for free.
...
[GeoGebra - the worlds favorite, free math tools used by over 100 million students and teachers](https://www.geogebra.org) - Free digital tools for class activities, graphing, geometry, collaborative whiteboard and more
...
[Hightail](https://www.hightail.com) - Simple and secure file sharing with Hightail. Send large files, preview visual assets, collect precise feedback and keep creative projects moving in one easy and secure cloud-based software. Try Hightail for free.
...
[Find yourself outside-Discover the best camping near you](https://www.hipcamp.com) - From public parks to private land, we're the most comprehensive guide to camping across the US. Camp on ranches, farms, vineyards and land preserves.

2022-11-05T23:14:05.572Z
...
[JustBeamIt - file transfer made easy](https://www.justbeamit.com) - file transfer made easy
...
[keybr.com - Typing lessons](https://www.keybr.com) - Teaching the world to type at the speed of thought! Typing lessons that work.
...
[MapsOfMind](https://www.mapsofmind.com) - The go-to tool for all your mind mapping needs! Unlimited map customization features and easy to use UI. Create.Share.Export your mind maps!

2022-11-05T23:14:05.570Z
...
[Travelscope Interactive worldmap of visa-free travel A Chrome Experiment](https://www.markuslerner.com/travelscope) - nan
...
[Movemap - explore where to live next](https://www.movemap.io/explore/us) - Find the place that matches your preferences in weather, culture, and cost of living
...
[My WiFi Sign](https://www.mywifisign.com) - This tool lets you quickly create a printable sign with your WiFi credentials.
...
[Earth.fm: Listen to nature sounds, fall in love with the Earth](https://www.naturesoundmap.com) - A non-profit, growing library of immersive nature sounds from all over the world. Become part of our family and help preserve the planet.
...
[Eat well](https://www.nhs.uk/live-well/eat-well) - Information and guidance about eating a healthy, balanced diet.
...
[OldMapsOnline](https://www.oldmapsonline.org) - The easy-to-use getaway to historical maps in libraries around the world.

2022-11-05T23:14:05.568Z
...
[Drone Mapping Software - OpenDroneMap](https://www.opendronemap.org) - Drone mapping software. Generate maps, point clouds, 3D models and DEMs from images, any orientation, any camera.
...
[OpenHistoricalMap](https://www.openhistoricalmap.org) - OpenHistoricalMap is a project designed to store and display map data throughout the history of the world. This is a work in progress, we'll be playing around with many new features as we time-enable the site. We encourage you to start playing around and editing data, too.
...
[Passbolt-The open source password manager for teams](https://www.passbolt.com) - Passbolt is an open source password manager designed for team collaboration. Securely generate, store, manage and monitor your team credentials. Try it now!
...
[Rainmeter, desktop customization tool](https://www.rainmeter.net) - Rainmeter allows you to display customizable skins on your desktop, from hardware usage meters to fully functional audio visualizers. You are only limited by your imagination and creativity.
...
[SendGB-Send Large Files-Free file transfer](https://www.sendgb.com) - nan
...
[Seterra - The Ultimate Map Quiz Site!](https://www.seterra.com) - Learn world geography the easy way! Seterra is a map quiz game, available online and as an app for iOS an Android. Using Seterra, you can quickly learn to locate countries, capitals, cities, rivers lakes and much more on a map.
...
[SlugBooks - compare cheap used/rental textbook prices](https://www.slugbooks.com) - SlugBooks compares all the prices between the biggest used and rental textbook sites so college students can save the most money.
...
[Remember the import things in your life](https://www.spacedtime.com) - Using the spaced time repetition technique, you can permemantly store information in your brain, instead of the cloud

2022-11-05T23:14:05.565Z
...
[Spreeder](https://www.spreeder.com) - Read 3x faster with full comprehension, save time, and be super-productive.
...
[Sync Text and Files Across your WiFi network!-Simple.Savr@else Simple.Savr](https://www.ssavr.com) - Simple.Savr: Type text or upload files that are instantly available across all your devices on your WiFi. Just start typing share text!
...
[Their News: Escape your bubble](https://www.their.news) - Break out of your political bubble by reading news from the entire political spectrum!

2022-11-05T23:14:05.564Z
...
[Tomorrow - A Pragmatic Guide to Climate Change](https://www.tmrow.com/climatechange) - This is a pragmatic guide to what Climate Change is, what the drivers behind it are, and what we as individuals can do about it.
...
[tree.fm Tune Into Forests From Around The World](https://www.tree.fm) - People around the world recorded the sounds of their forests, so you can escape into nature, while in lockdown or unable to travel. Use this site to chill, meditate or do some digital shinrin-yoku.
...
[A new way to read & write Markdown](https://www.typora.io) - Typora is a cross-platform minimal markdown editor, providing seamless experience for both markdown readers and writers.
...
[World Clock & Time Converter](https://www.worldtimebuddy.com) - Effortless time conversion and world time. Schedule conference calls, webinars & online meetings, plan travel and track flight arrival time across time zones.
...
[Zooniverse](https://www.zooniverse.org) - The Zooniverse is the worlds largest and most popular platform for people-powered research.
...
[PurpleAir-Real-time Air Quality Monitoring](https://www2.purpleair.com) - Hyper-local, real-time, public air quality map. Visualize PM2.5 AQI in your area for free. Useful to community scientists or air quality professionals alike, PurpleAir sensors are easy to install, requiring only a power outlet and WiFi.

2022-11-05T23:14:05.561Z
...
[xroom.app: Secure, simple and encrypted video conferencing](https://xroom.app) - Providing the worlds first conferencing platform combining simplicity, white-labelling and privacy. Features, plugins, streaming & API. Click to learn more!
...
[Yap](https://yap.chat) - An ephemeral, real-time chat room.
...
[Zenkit Suite](https://zenkit.com/en/use-cases/mind-map) - The project management tool that grows with you. Zenkit gives you the flexibility to create custom workflows, and the freedom to organize your data the way you want.
...
[Zorbi-Spaced Repetition Flashcards](https://zorbi.cards) - Flashcards that can predict when you'll forget them. Zorbi makes it easy for anyone to create flashcards from Chrome and note-taking tools like Notion.
...
[NewPipe - a free YouTube client](https://newpipe.schabi.org) - nan
...
[PortableApps.com - Portable software for USB, portable, and cloud drives](https://portableapps.com) - nan
...
[Create your own Custom Map-MapChart](https://mapchart.net) - Make your own custom map of the World, United States, Europe, and 50+ different maps. Color an editable map and download it for free to use in your project.
...
[404](https://live.amcharts.com) - nan
...
[Create Custom Map Charts with Free, Online Map Maker. Color Maps Online.](https://paintmaps.com) - nan
