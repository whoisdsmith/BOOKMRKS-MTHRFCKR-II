...
[0xAX (@0xAX)-Twitter](https://twitter.com/0xAX) - nan

2022-09-01T01:58:04.000Z

#Social #Media #dev sites
...
[Free and Easy Game-Making App-GDevelop](https://gdevelop.io) - GDevelop is an open-source, free, and easy game-making app. Find game development tutorials, publish to Android, iOS, and more.
...
[Alexey Palazhchenko on about.me](https://about.me/alexey.palazhchenko) - I am a software engineer.
...
[Crunchy Development](http://alisoftware.github.io) - Making your Swift code more fun , magical  and crunchier
...
[Alex Sharov (@AskAlexSharov)-Twitter](https://twitter.com/AskAlexSharov) - nan
...
[Blog](https://www.marcusnoble.co.uk) - The blog of Marcus Noble, self-described tinkerer, platform engineer and all round average guy!
...
[Bret Fisher - Docker Mastery and Kubernetes Mastery](https://www.bretfisher.com) - Bestselling Courses and Training on DevOps and Containers. Docker Captain. All Things Containers and Automation
...
[castagnait - Link in Bio & Creator Tools-Beacons](https://beacons.ai/castagnait) - nan
...
[Damian Edwards (@DamianEdwards)-Twitter](http://damianedwards.com) - nan
...
[Home](http://danielmschmidt.de) - Working @ HashiCorp on the CDK for Terraform team
...
[Daniel Rosenwasser (@drosenwasser)-Twitter](https://twitter.com/drosenwasser) - nan
...
[Jonah Lawrence Full Stack Developer](https://freshidea.com/jonah) - Jonah Lawrence  Full Stack Developer  Portfolio
...
[Favour-Full Stack Web Developer](https://dunsin.vercel.app) - Check out my portfolio
...
[从零开始的的搬砖日常](https://www.zhihu.com/column/Ehco-python) - Ehco
...
[Maximo Mussini Maximo Mussini](http://maximomussini.com) - Thoughts about development and product design.
...
[Victor Eke - Frontend developer](https://victoreke.com) - Victor Eke is a Frontend Developer based in Port Harcourt, Nigeria who is passionate about building web solutions and products around open source communities.
...
[Gourav Goyal - Personal site and blog](https://gourav.io) - Personal site and blog of a tech guy
...
[Harsh](https://harshcasper.com) - Personal Website of Harsh
...
[James Henry: TypeScript, JavaScript and Angular articles](https://jameshenry.blog) - Learn TypeScript, JavaScript and Angular with Microsoft MVP James Henry from the ground up. From Fundamentals to Pro!
...
[Thinkmill](http://www.thinkmill.com.au) - We are an internationally recognised design & development consultancy.
...
[Jelle Zijlstra](https://www.quora.com/profile/Jelle-Zijlstra) - Staff Engineer at Quora.
...
[Jeremy Ruston (@Jermolene)-Twitter](http://twitter.com/Jermolene) - nan
...
[~ my tech diary ~](http://kazucocoa.wordpress.com) - nan
...
[Kikobeats](https://kikobeats.com) - A millennial doing stuff on internet that ships software every day and builds digital products.
...
[Maarten Grootendorst](https://maartengrootendorst.com) - A Psychologist turned Data Scientist Residing at the Intersection of Artificial Intelligence and Human Behavior.
...
[Mark Baker's Blog](http://markbakeruk.net) - nan
...
[astro automata](https://astroautomata.com) - Personal website of Miles Cranmer
...
[Munif Tanjim](https://muniftanjim.dev) - nan
...
[Florian Roth (@cyb3rops)-Twitter](https://twitter.com/cyb3rops) - nan
...
[Ralim TEk](http://ralimtek.com) - Electronics & Embedded Engineering
...
[redth.codes](http://redth.codes) - such code, much rambling, so redth
...
[Rich Harris (@Rich_Harris)-Twitter](https://twitter.com/rich_harris) - nan
...
[RobLoach - Overview](https://robloach.net) - RobLoach has 776 repositories available. Follow their code on GitHub.
...
[Robin Malfait](https://robinmalfait.com) - Robin's personal website
...
[Samy Pesse (@SamyPesse)-Twitter](https://twitter.com/SamyPesse) - nan
...
[Gal Schlezinger](https://gal.hagever.com) - thoughts and codes
...
[Tikam Singh Alma DEV Community Profile](https://dev.to/tikam02) - Design-Debug-Develop
...
[Torsten Dittmann's Blog](https://dittmann.dev) - nan
...
[Manjusaka](http://manjusaka.itscoder.com) - nan
...
[Abhishek Thakur](https://www.bit.ly/abhitubesub) - I make videos about applied machine learning, deep learning, and data science. I am the world's first Quadruple Grand Master on Kaggle.  My code-intensive book, "Approaching (Almost) Any Machine Learning Problem" can be downloaded for free from: https://bit.ly/approachingml. If you like it you can also buy paperback copies :)  Feel free to contact me for sponsorships, unboxing, etc.
...
[Abraham Calf Developer, Photographer on the weekends.](https://abrahamcalf.com) - Developer, Open Sourcerer, Computer Scientist and Photographer.
...
[Aakansha's Blog](https://aakansha.dev) - Front-end @hackerrank- opensource
...
[Home - Adam Johnson](https://adamj.eu) - nan
...
[afc163 (@afc163)-Twitter](https://twitter.com/afc163) - nan
...
[Aidan Follestad's Site](https://af.codes) - Aidan Follestad's personal website. Checkout cool projects, work history, etc.
...
[GitHub - akaszynski/resume: Alex Kaszynski's Public Resume](https://github.com/akaszynski/resume) - Alex Kaszynski's Public Resume. Contribute to akaszynski/resume development by creating an account on GitHub.
...
[Nomic Foundation](https://nomiclabs.io) - nan
...
[Alex Page](https://alexpage.dev) - I lead multidisciplinary teams, build communities and create design systems with modern technology and thoughtful design.
...
[Fast Open-Source OLAP DBMS - ClickHouse](https://clickhouse.com) - ClickHouse is a fast open-source column-oriented database management system that allows generating analytical data reports in real-time using SQL queries
...
[Andrew Lock-.NET Escapades](http://andrewlock.net) - Hi, my name is Andrew, or Sock to most people. This blog is where I share my experiences as I journey into ASP.NET Core.
...
[Learn In-Demand Skills. Get Hired. Advance Your Career.-Zero To Mastery](https://zerotomastery.io) - Stop wasting time on boring, outdated tutorials. Join 750,000+ students learning in-demand skills & getting hired at companies like Apple, Google, Amazon, Tesla & Shopify.
...
[- AppleBOY](https://blog.wu-boy.com) - nan
...
[ArgyleInk](https://nerdy.dev) - Default page description
...
[Arkadii Ivanov (@arkann1985)-Twitter](https://twitter.com/arkann1985) - nan
...
[Armon Dadgar (@armon)-Twitter](http://twitter.com/armon) - nan
...
[arpit456jain-Twitter, Facebook-Linktree](https://linktr.ee/arpit456jain) - Linktree. Make your link do more.
...
[Artur Arseniev (@artur_arseniev)-Twitter](https://twitter.com/artur_arseniev) - nan
...
[yoann padioleau (@yoann_padioleau)-Twitter](https://twitter.com/yoann_padioleau) - nan
...
[Tapas Adhikary writer, youtuber, creator, mentor](https://tapasadhikary.com) - A passionate content creator sharing knowledge and experience using articles, videos, and opensource projects.
...
[Weblog of A Pythonista](https://auvipy.blogspot.com) - nan
...
[Shuhei Kadowaki](https://aviatesk.github.io) - nothing
...
[banteg](https://t.me/banteg) - bunny talisman of yearn
...
[Ansible is Simple IT Automation](http://www.ansible.com) - Ansible is the simplest way to automate apps and IT infrastructure. Application Deployment + Configuration Management + Continuous Delivery.
...
[Benjamin Coe (@BenjaminCoe)-Twitter](https://twitter.com/benjamincoe) - nan
...
[bdougie.live](https://bdougie.live) - A digital garden for finding out what bdougie is working on.
...
[Web Development Resource Hub Bryan Guner](https://bgoonz-blog.netlify.app) - Web-Dev-Hub
...
[BIGTREETECH-Makes 3D Printing within Reach-Official Website](https://www.bigtree-tech.com) - For makers. By makers. BIGTREETECH offers a range of high-quality 3D printers, 3D printing components, software, materials, and support.
...
[Alexander Borsuk: Software Engineer, MScEng, co-founder of Organic Maps, VibroBox & MAPS.ME](https://alex.bio) - Hi! I'm an IT Engineer and researcher, co-founder of Organic Maps and MAPS.ME (offline iOS and Android maps for travelers), founding investor of VibroBox (Prescriptive Maintenance and vibration-based diagnostics of rotary equipment).
...
[codeburst](https://codeburst.io) - Bursts of code to power through your day. Web Development articles, tutorials, and news.
...
[Visual Studio Code - Code Editing. Redefined](http://code.visualstudio.com) - Visual Studio Code is a code editor redefined and optimized for building and debugging modern web and cloud applications. Visual Studio Code is free and available on your favorite platform - Linux, macOS, and Windows.
...
[brandtbucher - Overview](https://brandtbucher.com) - @python Core Developer. brandtbucher has 23 repositories available. Follow their code on GitHub.
...
[Brent Shaffer (@bshaffer)-Twitter](https://twitter.com/bshaffer) - nan
...
[leonsbox](http://leonsbox.com) - Father of 2 boys, indie open-source developer, love automation and Go.
...
[Brenton Wiernik](https://wiernik.org) - Assistant Professor of IO Psychology
...
[Cal Stephens Portfolio](https://calstephens.tech) - iOS Engineer living in San Francisco, CA. Independent creator behind Photo Map, AR Planes, Window, and more. Working at Airbnb. Previously at Apple and MailChimp. Georgia Tech Class of 2019.
...
[Home](https://captnemo.in) - You've found Nemo!
...
[Carlos Antonio da Silva on about.me](http://about.me/carlosantoniodasilva) - I am a software engineer in Rio do Sul, Brazil. Visit my company website.
...
[cberner.com](https://cberner.com) - cberner.com - A blog about Linux, Programming, and Computers
...
[Christian Oliff](https://christianoliff.com) - Online Adventures of a Front-End Web Developer
...
[Colin McDonnell @colinhacks](https://colinhacks.com) - Founder of Bagel Health, creator of Zod, open-sourcer, poptimist, movie buff. Wanna go to Taco Bell?
...
[AJ ONeal](https://coolaj86.com) - I'm an adult (AJ ONeal, to be exact); I do what I want! (mostly makin' Awesome with Golang, Rust, and NodeJS). Here lay the 11teen ways you can contact me and my articles.
...
[Takuya Matsuyama](https://www.craftz.dog) - Takuya's homepage
...
[Software Engineering](http://damienbod.com) - Web development
...
[| Seven Coffee Cups](https://www.danielhu.cn) - nan
...
[Danilo Woznica - Design-driven developer](https://danilowoz.com) - Design-driven developer focused on making React products.
...
[MEEDU.APP - Educacion online](https://meedu.app) - Cursos en espanol de desarrollo de software, diseno grafico, ux, desarrollo movil, desarrollo web.
...
[Daybrush - CSS Motion Graphics Website](https://daybrush.com) - Daybrush. CSS Motion Graphics Website. I'm Front-end enginner with main focus on Develope and Design.
...
[Dessalines (@dessalines@mastodon.social)](https://mastodon.social/@dessalines) - 138 Posts, 83 Following, 206 Followers  Communist programmer. Recorder of commie audiobooks. He-him.
...
[Parcel The zero configuration build tool for the web.](https://parceljs.org) - Parcel combines a great out-of-the-box development experience with a scalable architecture that can take your project from just getting started to massive production application.
...
[Doug Finke](https://www.youtube.com/dougfinke) - Share your videos with friends, family, and the world
...
[Schwarz IT](https://www.it.schwarz) - Jobs und Karriere bei der Schwarz IT
...
[dodyg (@dodyg)-Twitter](https://twitter.com/dodyg) - nan
...
[The Guild - Open Source](http://the-guild.dev) - Open Source developers with experience of working with the largest companies and applications. GraphQL consulting, workshops and trainings.
...
[User David Sherret](http://stackoverflow.com/users/188246/david-sherret) - Stack Overflow-The Worlds Largest Online Community for Developers
...
[dsnet - Overview](http://digital-static.net) - dsnet has 22 repositories available. Follow their code on GitHub.
...
[Dylan Sather](http://dylburger.com) - Dylan Sather Personal Website
...
[Enes Ozturk](https://ozturkenes.com) - Software developer and paragliding pilot
...
[Erez Shinan](https://www.erezsh.com/professional) - Erez Shinan's website
...
[Eric Clemmons](https://ericclemmons.com) - I'm Eric Clemmons, an engineering leader specializing in autonomous, outcome-driven remote teams with over 15 years of experience as an open-source JavaScript/Node.js developer focused on UX & DX.
...
[Apuntes Inchequeables](https://facundoolano.github.io) - Por favor, acepte el misterio.
...
[Fatih Arslan](https://arslan.io) - My thoughts about Programming, Coffee, Bags and various other stuff
...
[Francois Chollet (@fchollet)-Twitter](https://twitter.com/fchollet) - nan
...
[Tips and Tutorials for WordPress-Felipe Elia](https://felipeelia.dev) - Dicas e tutoriais completos para quem quer aprender WordPress! Saiba mais sobre temas, plugins e solucoes para sites e sistemas WP.
...
[Home-Felipe Fialho - Front-end Developer](https://felipefialho.com) - Site pessoal e blog de um desenvolvedor Front-end apaixonado por criar coisas e compartilhar boas ideias.
...
[苏千 · Yuque](https://www.yuque.com/fengmk2) - nan
...
[Filip Hracek](https://filiph.net) - Filip is a programming buff with formal training in journalism.
...
[Articles about Ruby, Rails, JavaScript, and more. By Nando Vieira.](https://nandovieira.com) - nan
...
[Franck Nijhof's Personal Homepage](https://frenck.dev) - nan
...
[Frost's Blog](https://frostming.com) - nan
...
[Geoff Boeing](https://geoffboeing.com) - Urban planning and spatial analysis professor at USC
...
[David Glasser](http://flickr.com/photos/glasser) - Explore David Glassers 5,223 photos on Flickr!
...
[greweb.me](https://greweb.me) - generative artist who uses code to make art, explores the frontier of abstract art with algorithms pushing forward to more realistic scenery. Explore physical art via 'Plotting', which consist of drawing with fountain pens on robot. I don't do prints, I do plots: Every physical outcome is truly unique!
...
[Ask and Learn - greatghoul's blog](https://anl.gg) - greatghoul
...
[李辉的个人主页](https://greyli.com) - HelloGrey Li Web
...
[Welcome To Hamels Professional Page](http://hamel.dev) - A collection of technical blogs and talks on machine learning and data science.
...
[ISciNumPy.dev](https://iscinumpy.gitlab.io) - Favorite posts and series C++11141720  macOSSetup (AS)  AzureDevOps (PythonWheels)  Conda-ForgeROOT  CLI11  GooFit  cibuildwheel  Hist  PythonBindings  Python23,3.8,3.103.11
...
[Tao X (@hewigovens)-Twitter](https://twitter.com/hewigovens) - nan
...
[Huozhi](https://huozhi.im) - Illustrating arts and techs
...
[Connor Tumbleson](https://connortumbleson.com) - Hi, I'm Connor Tumbleson, I blog weekly, maintain Apktool, work at Sourcetoad and speak at events around Florida.
...
[Welcome](https://www.armbian.com) - nan
...
[Learn Go Programming](https://blog.learngoprogramming.com) - Visual, concise and detailed tutorials, tips and tricks about Go (aka Golang).
...
[Guilherme Rambo (@_inside)-Twitter](https://twitter.com/_inside) - nan
...
[Jason Taylor](https://jasontaylor.dev) - Solution Architect
...
[Jatin Chowdhury](https://ccrma.stanford.edu/~jatin) - Jatin Chowdhury is a student.
...
[thirty-four](https://jeffy.info) - thirty-four is crafted with love in Brooklyn, by Jeff Posnick.
...
[Jenny Bryan](https://jennybryan.org) - Jenny Bryan's personal website
...
[Dotan Nahum Medium](https://medium.com/@jondot) - Read writing from Dotan Nahum on Medium. @jondot-Founder & CEO @ Spectral. Rust + FP + Hacking + Cracking + OSS. Previously CTO @ HiredScore, Como, Conduit.
...
[Hey there! Joshen here.](http://joshen.me) - Full Stack Developer, Budding Designer
...
[Joao Pedro Schmitz](https://joaopedro.dev) - Front-End Engineer at Hygraph. Working hard. Learning every day. I share thoughts, stories, and ideas.
...
[Vim for VSCode](https://vimforvscode.com) - This Vim for VSCode course teaches you how use Vim inside your favorite editor through hands-on exercises and active learning techniques. Get it today!
...
[Justin Spahr-Summers](https://jspahrsummers.com) - nan
...
[Javier Suarez-Blog](http://javiersuarezruiz.wordpress.com) - C#, .NET MAUI, .NET y mucho mas!
...
[Julia Silge](https://juliasilge.com) - I'm a tool builder, author, international keynote speaker, and real-world practitioner focusing on data analysis and machine learning. I love making beautiful charts and communicating about technical topics with diverse audiences.
...
[Julien Chaumond (@julien_c)-Twitter](https://twitter.com/julien_c) - nan
...
[Vincent Muhler Medium](https://medium.com/@muehler.v) - Read writing from Vincent Muhler on Medium. Bringing OpenCV to JavaScript https://github.com/justadudewhohacks/opencv4nodejs. Every day, Vincent Muhler and thousands of other voices read, write, and share important stories on Medium.
...
[justjavac (@justjavac)-Twitter](https://twitter.com/justjavac) - nan
...
[moxey.eth-Rainbow](https://rainbow.me/moxey.eth) - Check it out
...
[Kamil Ogorek](https://kamilogorek.com) - Software development passionate mainly focused on client-side technologies. Currently working as Software Engineer at Sentry. Weightlifter, powerlifter, training and nutrition geek.
...
[Learn to Code in Vienna - UpLeveled](https://upleveled.io) - Looking for a new path as a professional developer or an entrepreneur launching your own tech product? UpLeveled bootcamps and mentoring are here to help!
...
[Devblog of @kdy1](https://kdy1.dev) - Make the web faster
...
[Kenny Kerr](http://kennykerr.ca) - Creator of C++/WinRT and the Windows crate for Rust  Engineer on the Windows team at Microsoft  Romans 1:16
...
[kevindew](https://kevindew.me) - nan
...
[Hi](https://kevinslin.com) - Kevin home page
...
[Alon Zakai (@kripken)-Twitter](https://twitter.com/kripken) - nan
...
[Krzysztof Zabocki](http://merowing.info) - Creating award-winning apps, building tools and frameworks used by 80,000+ apps.
...
[Leandro Moreira](https://leandromoreira.com) - Software development
...
[Lee Robinson Developer, writer, creator.](https://leerob.io) - Front-end developer, JavaScript enthusiast, and course creator.
...
[Leigh McCulloch](https://leighmcculloch.com) - Software Engineer-Go-Ruby
...
[Daisuke Maki Medium](https://medium.com/@lestrrat) - Read writing from Daisuke Maki on Medium. Go/perl hacker; author of peco; works @ Mercari; ex-mastermind of builderscon; Proud father of three boys;. Every day, Daisuke Maki and thousands of other voices read, write, and share important stories on Medium.
...
[Panayiotis Lipiridis (Lipis) lipis.dev](https://lipis.dev) - Web dude at Wire
...
[Liran Tal-Ruby Lockfile Injection (@liran_tal)-Twitter](https://twitter.com/liran_tal) - nan
...
[Pay using PayPal.Me](https://paypal.me/liuchengxu) - Go to PayPal.Me/liuchengxu and enter the amount. It's safer and more secure. Don't have a PayPal account? No problem.
...
[hyperbo.la](https://hyperbo.la) - hyperbo.la: Ryan Lopopolo's website.
...
[Lovell Fuller](http://lovell.info) - Internet Technologist - London, UK
...
[Lecoq.io-Simon Lecoq's online portfolio](https://simon.lecoq.io) - Portfolio of a weird developer. Discover some of my works, projects, and games or consult my resume to know more about me :)
...
[Mathias Fredriksson](https://mathias.fi) - nan
...
[Welcome](https://jlwagner.net) - The home page of technical writer, author, and speaker Jeremy Wagner.
...
[Standup Jack](https://standupjack.com) - Standup Jack is a Slack Bot for your Standups. Each weekday at a time of your choosing, Jack will message you a few questions. These questions are designed to help you plan your day and let your teammates know what you're up to.
...
[.NET Development Addict](http://dotnetdevaddict.co.za) - Just a quick post on how to watch out for some small gotchas when using Task, async and await. No big revelations, just understand what you mean when you run a Task.
...
[Matt Borgerson](https://mborgerson.com) - nan
...
[Security Automation (SOAR) for Everyone](https://www.demisto.com) - Cortex XSOAR is the industry's most comprehensive security orchestration automation and response (SOAR) platform. Explore Cortex XSOAR.
...
[messense (Messense Lv) on Keybase](https://keybase.io/messense) - messense (Messense Lv) is now on Keybase, an open source app for encryption and cryptography.
...
[Minko Gechev's blog](https://blog.mgechev.com) - nan
...
[mingrammer's note](https://mingrammer.com) - mingrammer's dev logs
...
[MishManners Links](https://mishmanners.info) - Connect with MishManners, AKA the Hackathon Queen, on socials, find articles, see affiliates links, and more.
...
[Miguel Solorio (@miguelsolorio_)-Twitter](https://twitter.com/miguelsolorio_) - nan
...
[mokacoding](http://mokacoding.com) - A blog about software testing, iOS development, automation, and productivity.
...
[Magnum Engine](https://magnum.graphics) - Lightweight and modular C++11/C++14 graphics middleware for games and data visualization
...
[Sync your .env files](https://dotenv.org) - Sync your .env files, quickly & securely
...
[Vladimir Agafonkin](https://agafonkin.com) - Software engineer, open source enthusiast, rock musician, father of twin girls, Ukrainian.
...
[mstoykov - Overview](https://github.com/mstoykov) - mstoykov has 113 repositories available. Follow their code on GitHub.
...
[n1ru4l - Overview](https://n1ru4l.cloud) - n1ru4l has 218 repositories available. Follow their code on GitHub.
...
[The ephemera of Nicolas Gallagher](http://nicolasgallagher.com) - nan
...
[Lazar Nikolov - Developer, designer, course creator.](https://nikolovlazar.com) - Full-stack Engineer, UI Designer, and Open Source Advocate.
...
[040code](https://040code.github.io) - A developers blog
...
[Welcome](https://nvbn.github.io) - nan
...
[site_terminal.py](https://odyslam.com) - Odysseas personal site
...
[orhun(8)](https://orhun.dev) - Personal website of Orhun Parmaksz
...
[Alex Rodionov Medium](http://medium.com/@p0deje) - Read writing from Alex Rodionov on Medium. Selenium/Watir Committer, Paradev @ Toptal. Every day, Alex Rodionov and thousands of other voices read, write, and share important stories on Medium.
...
[Paco Coursey](https://paco.me) - Crafting interfaces. Webarchitect at Linear. Building polished software and web experiences.
...
[Pekka Enberg](https://penberg.org) - Software Engineer
...
[The blog of Peter Evans](https://peterevans.dev) - Thoughts and notes on software engineering, architecture and testing.
...
[philschmid blog](https://www.philschmid.de) - Hello, my name is Philipp. I write about machine learning and cloud with. You will find tutorials and explanations about AWS, NLP, Transformers and more
...
[Phuoc Nguyen (@nghuuphuoc)-Twitter](https://twitter.com/nghuuphuoc) - nan
...
[cat /dev/random](https://prakhar.me) - My name is Prakhar Srivastav and I build stuff. I love programming, Python, Vim and ice tea, not necessarily in that order.
...
[The Little Grasshopper](http://prideout.net) - Philip's graphics and math blog.
...
[The ZAP Homepage](https://www.zaproxy.org) - Welcome to ZAP!
...
[Alex (@quasilyte)-Twitter](https://twitter.com/quasilyte) - nan
...
[Sofware Development](https://robertohuertas.com) - A Barcelona-based web & mobile developer wandering through cyberspace. Organizer of bcn_rust. Currently working at Koa Health.
...
[Robin Cornett-robin gale cornett](https://robincornett.com) - Robin Cornett is a WordPress developer and designer, working with the Genesis Framework, based near Chattanooga, Tennessee.
...
[robingenz - Overview](https://robingenz.dev) - CS Student and Full Stack Developer- @ionic-team Developer Expert- @capacitor-community Member  - robingenz
...
[Price Smarter, Sell bigger!](https://www.paritydeals.com) - Optimize your product pricing across countries to maximize revenue.
...
[Mark Sagi-Kazar](https://sagikazarmark.hu) - nan
...
[Screeb - Product-Led User Research [Try for Free Today]](https://screeb.app) - Increase your Growth, Adoption & Retention with Screeb, the first Product-Led User Research platform made for Product teams!
...
[Home](https://satwikkansal.xyz) - Satwik Kansals website and portfolio.
...
[Satyajit Sahoo (@satya164)-Twitter](https://twitter.com/@satya164) - nan
...
[Schalk Neethling Medium](https://medium.com/@schalkneethling) - Read writing from Schalk Neethling on Medium. I write about mental health, addiction, sober living, living your best life through an active lifestyle and a whole food plant-based diet. Psychedelic curios :).
...
[seanmonstar](https://seanmonstar.com) - nan
...
[My current experience with GitHub](https://gist.github.com/seanpm2001/7e40a0e13c066a57577d8200b1afc6a3) - My current experience with GitHub  GitHub
...
[Sage (@thesegunadebayo)-Twitter](https://twitter.com/thesegunadebayo) - nan
...
[seladb (@seladb)-Twitter](https://twitter.com/seladb) - nan
...
[Cloud Researcher](https://seokho-son.github.io) - Artificial Intelligence Research Laboratory, ETRI
...
[Home-Seth Vargo](https://www.sethvargo.com) - Seth Vargo is an engineer at Google. Previously he worked at HashiCorp, Chef Software, CustomInk, and some Pittsburgh-based startups. He is the author of Learning Chef and is passionate about reducing inequality in technology. When he is not writing, working on open source, teaching, or speaking at conferences, Seth advises non-profits.
...
[Shahed Nasser's Blog - Shahed Nasser](https://blog.shahednasser.com) - Articles and Tutorials About Technology and Programming
...
[shivammathur - Overview](https://shivammathur.com) - Creator of @setup-php. shivammathur has 83 repositories available. Follow their code on GitHub.
...
[Solomon Hykes (@solomonstre)-Twitter](https://twitter.com/solomonstre) - nan
...
[Simon Basle on about.me](http://about.me/simonbasle) - I am a software engineer and public speaker in Nantes, France. View my repo.
...
[Jaewoong Eum Medium](https://medium.com/@skydoves) - Read writing from Jaewoong Eum on Medium. Android Developer Advocate @ Stream   GDE for Android  OSS engineer. Love psychology, magic tricks, and writing poems. https://github.com/skydoves.
...
[Stephen Roller](http://stephenroller.com) - nan
...
[Builder.io - Drag and drop experience builder](https://www.builder.io) - Build and optimize digital experiences for any tech stack, visually.
...
[steve mao (@MaoStevemao)-Twitter](https://twitter.com/MaoStevemao) - nan
...
[Utah Mapping Portal](https://gis.utah.gov) - Utah Mapping Portal-The Utah Geospatial Resource Center
...
[くりにっき](https://sue445.hatenablog.com) - nan
...
[Raphael @sundowndev](https://crvx.fr) - Raphael Cerveaux, web, security and OSINT enthusiast.
...
[Public Object](http://publicobject.com) - Jesse Wilson on programming.
...
[SWHarden.com - The personal website of Scott W Harden](https://swharden.com) - nan
...
[bit.ovh - a piece of my mind](https://bit.ovh) - nan
...
[Keep Software Engineering Soft-Kevin Wang's Blog](https://thekevinwang.com) - Kevin Wang's blog on anything from cloud architecture, to serverless tech, to Kettle Chips. Maybe some random musings here and there.
...
[A privacy-first, open-source knowledge base](https://logseq.com) - A privacy-first, open-source platform for knowledge management and collaboration.
...
[Tim MacDonald Laravel & PHP Developer Melbourne, Australia](https://timacdonald.me) - Developing engaging and performant web applications with Laravel and PHP. Love building for the web.
...
[Thomas Lively (@tlively52)-Twitter](https://twitter.com/tlively52) - nan
...
[While My MCMC Gently Samples](https://twiecki.io) - nan
...
[Marin Atanasov - WordPress Engineer and Consultant](https://marinatanasov.com) - Marin Atanasov is a full stack web developer, WordPress engineer and consultant, JavaScript engineer, Automattician, coding instructor, WordPress contributor, bug squasher, guitar and piano player, photography enthusiast and coffee addict.
...
[CyberUni](https://www.youtube.com/channel/UCNHNzeu22sYaBraG3WrdqlA) - Anything about programming, engineering, and gaming
...
[unixorn.github.io](http://unixorn.github.io) - nan
...
[Posts](https://www.utam0k.jp/en/post) - utam0k
...
[Vadim Demedes](https://vadimdemedes.com) - Maker of apps and open source projects
...
[Vasco Asturianos Blocks - bl.ocks.org](https://bl.ocks.org/vasturiano) - nan
...
[Learn React Native Gestures and Animations](https://start-react-native.dev) - Learn React Native Gesture Handler and Reanimated to build user experiences that run at 60 fps, even on low-end devices.
...
[Serhii Kulykov (@serhiikulykov)-Twitter](https://twitter.com/serhiikulykov) - nan
...
[Ronan Sandford (ronan.eth) - Ronan Sandford's Personal Website](https://ronan.eth.limo) - Ronan Sandford's Personal Website
...
[Uwes Blog](http://uwekorn.com) - Uwe L. Korn, Data Scientist, Music Hacker and Food lover.
...
[Yihui Xie |](https://yihui.org) - Personal website of Yihui Xie;
...
[YK aka CS Dojo (@ykdojo)-Twitter](https://twitter.com/ykdojo) - nan
...
[zimbatm](https://zimbatm.com) - Hello! Welcome to my personal website.
...
[zserge's blog](https://zserge.com) - Home page of Serge Zaitsev
